...
def compute_fair_price_ensemble(
    *,
    ...
    # When USE_SECTOR_COE is True the per-GICS Ke from cost_of_equity.py is
    # used instead of the flat COST_OF_EQUITY = 0.10 constant.  Default False
    # (data-collection PR per Rule 18 — production behaviour unchanged until
    # the flip PR lands after ≥ 1 cron's delta-flag-count measurement).
    rim_cost_of_equity = (
