...
Vendored from
<https://github.com/thananon/9arm-skills> (commit
`d714cb84f35e0c42b2ca29bca505e564ab9f2bcd`, 2026-05-20).
Original author: thananon ("9arm").

**License status: not declared upstream at vendoring time.** No
`LICENSE` file at upstream root, no `license:` field in upstream
YAML frontmatter. Vendoring proceeded on best-effort basis pending
upstream license clarification — see
<https://github.com/dackclup/quantrank/issues/137> for tracker.
If upstream declines redistribution, this skill will be removed.

See `THIRD_PARTY_NOTICES.md` for full provenance disclosure.
