...
// Valuation-ensemble warning chips humanize their flag via the shared
// `flagLabel` map (`@/lib/flag-labels`) — the SAME source the cross-stock
// CompareMatrix risk row uses, so a flag never reads "beneish high" on one
// surface and "Beneish M-score" on another. Unknown flags fall back to Title
// Case there (forward-safe per ensemble.py:142).
