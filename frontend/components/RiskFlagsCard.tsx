...
//
// Motion: the veto rows render STATICALLY — no entrance animation. The
// earlier flag-pulse attention-beat was removed 2026-05-31 per user request
// ("ช่อง risk flag เอา animation ออก"); the card's rose ring + tone already
// carry the "look here" weight without motion. (The class token is written
// without the `animate-` prefix on purpose — Tailwind's content scanner would
// otherwise re-emit the now-unused utility from this very comment.)
