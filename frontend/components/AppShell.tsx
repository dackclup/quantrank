  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-20 flex items-center gap-3 border-b border-slate-200 bg-white/95 px-4 py-2 backdrop-blur md:px-6">
          <button
            type="button"
          ...
          <span className="font-slab text-base font-semibold tracking-tight text-slate-900 md:hidden">QuantRank</span>
          <span className="ml-auto text-xs text-slate-500">US equity stock ranking</span>
        </header>
        <Disclaimer />
        ...
        <footer className="border-t border-slate-200 bg-white">
          <div className="mx-auto max-w-6xl px-4 py-6 text-xs text-slate-500 md:px-8">
