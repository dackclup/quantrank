...
export function Disclaimer() {
  ...
  return (
    <div role="alert" className="border-b border-slate-200 bg-slate-50 text-slate-600">
      <div className="mx-auto flex max-w-6xl items-start gap-2 px-4 py-2 text-xs">
        ...
        <div className="min-w-0 flex-1">
          <span className="font-medium text-slate-700">Educational use only.</span>
          ...
          <button
            ...
            className="ml-1 text-slate-500 underline-offset-2 hover:text-slate-900 hover:underline"
          >
            {expanded ? 'less' : 'more'}
          </button>
        </div>
