      ...
      <aside
        ...
        className={`fixed inset-y-0 left-0 z-40 flex flex-col border-r border-slate-200 bg-white ${
          animate
            ...
            : 'transition-none'
        } motion-reduce:transition-none dark:border-slate-800 dark:bg-slate-950 md:sticky md:top-[calc(3.5rem_+_46px)] md:h-[calc(100vh_-_3.5rem_-_46px)] md:translate-x-0 ${
