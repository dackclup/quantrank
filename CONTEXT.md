...
| Sub-agent catalog (25 agents, 5 tiers, 8 coordination flows) + agent-team recipes | [`.claude/agents/README.md`](.claude/agents/README.md) · [`TEAMS.md`](.claude/agents/TEAMS.md) |
...
| `.claude/agents/` | 25 project-specific sub-agents in 5 tiers |
