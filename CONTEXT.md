...
| Sub-agent roster | 22 agents in 5 tiers (5 fable + 17 sonnet) |
...
| Sub-agent catalog (22 agents, 5 tiers, 8 coordination flows) + agent-team recipes | [`.claude/agents/README.md`](.claude/agents/README.md) · [`TEAMS.md`](.claude/agents/TEAMS.md) |
...
| `.claude/agents/` | 22 project-specific sub-agents in 5 tiers |
