...
| Sub-agent roster | 24 agents in 5 tiers (5 fable + 19 sonnet) |
...
| Sub-agent catalog (24 agents, 5 tiers, 8 coordination flows) + agent-team recipes | [`.claude/agents/README.md`](.claude/agents/README.md) · [`TEAMS.md`](.claude/agents/TEAMS.md) |
...
| `.claude/agents/` | 24 project-specific sub-agents in 5 tiers |
