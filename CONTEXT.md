...
| Sub-agent roster | 26 agents in 5 tiers (6 opus + 20 sonnet) |
...
| Sub-agent catalog (26 agents, 5 tiers, 9 coordination flows) + agent-team recipes | [`.claude/agents/README.md`](.claude/agents/README.md) · [`TEAMS.md`](.claude/agents/TEAMS.md) |
