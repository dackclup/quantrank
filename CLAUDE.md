...
**In flight** (not yet merged on `main`): nothing currently in flight (the `v2.0.0-phase8` tag PUBLISHED 2026-06-23 at `8c89a5af0`). `low_liquidity` veto promotion (#544, KEEP-ANNOTATE for v2.0) + Bonferroni provisional-threshold re-derivation deferred post-v2.0. Merged
