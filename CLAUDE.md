...
- **feat(portfolio) — ADAPTIVE AI-sized basket, user count slider removed
  ...
  `scripts/backfill_portfolio_pit.py`, routed through `methodology-scientist`
  for ratification. Evidence (production veto-replayed artifact, real engine
