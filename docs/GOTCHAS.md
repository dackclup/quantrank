...
- **The ADAPTIVE book is the headline; the 1-10 slider is legacy-fallback-only.** When the artifact
  ...
  (`scripts/backfill_portfolio_pit.py`) pending/per methodology ratification.
