...
- **Next universe step**: Slice 6 (SML tab/chip — frontend small-cap badge) → Slice 7 (cron flip to sp1500) → Slice 8 (v2.0 — Bonferroni shadow calibration + virtualized 1500-row table + liquidity-veto promotion decision).
