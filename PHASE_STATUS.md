...
| Subagent inventory | **27** in 5 tiers (6 opus + 21 sonnet; 25 `effort: max`, 2 `high`) — roster + routing matrix: `.claude/agents/README.md` (Tier 4 adds the cross-cutting `agent-output-verifier` "จับผิด" fact-checker + the `loop-engineer` work-loop architect) |
